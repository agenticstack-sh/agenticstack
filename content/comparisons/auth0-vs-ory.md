...
**Modular open-source architecture.** Ory provides independent microservices: Kratos for user management, Hydra for OAuth2/OIDC, and Keto for permissions. You choose which components to deploy and inspect or modify the source.
