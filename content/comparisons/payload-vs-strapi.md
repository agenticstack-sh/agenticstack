...
* **Pick Payload** when the team is TypeScript-native and wants the content model to be as rigorously typed and version-controlled as the rest of the codebase, and is prepared to build outbound event dispatch if external agent pipelines are needed.
