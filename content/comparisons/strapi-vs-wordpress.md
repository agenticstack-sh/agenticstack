...
**Do not pick WordPress as a net-new headless CMS for agent use cases.** The absence of native outgoing webhooks, GraphQL in core, and content-scoped credentials means rebuilding each of those integration layers outside the platform. Strapi addresses all three gaps natively.
